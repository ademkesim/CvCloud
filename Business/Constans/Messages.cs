...
namespace Business.Constans
{
    public static class Messages
    {
        ...
        public static string CvAdded = "Cv'niz Kaydedildi";
        public static string CvUpdated = "Cv'niz başarıyla  Güncellendi";
        public static string CvDeleted = "Cv'niz silindi";
